...
export function TopPagesTable({ pages }: TopPagesTableProps) {
  ...
  return (
    <div className="min-w-0 rounded-xl border border-gray-200 bg-white p-5 shadow-sm max-sm:p-4">
      ...
      {visiblePages.length === 0 ? (
        ...
        <div className="max-w-full overflow-hidden overscroll-x-contain rounded-lg border border-gray-100 max-sm:overflow-x-auto">
          <table className="w-full text-left max-sm:min-w-[32rem]">
            <thead>
                ...
                >
                  <td className="px-3 py-2.5">
                    <div className="flex min-w-0 items-center gap-2">
                      ...
                      <span className="max-w-[12.5rem] min-w-0 truncate text-xs font-medium text-gray-700">
                        {page.page}
                      </span>
                    </div>
                  </td>
